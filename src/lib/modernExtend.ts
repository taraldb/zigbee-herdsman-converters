...
export function electricityMeter(args?: ElectricityMeterArgs): ModernExtend {
    ...
    const configureLookup = {
        haElectricalMeasurement: {
            ...
            current_phase_b: {attribute: 'rmsCurrentPhB', divisor: 'acCurrentDivisor', multiplier: 'acCurrentMultiplier', forced: args.current, change: 0.05},
            current_phase_c: {attribute: 'rmsCurrentPhC', divisor: 'acCurrentDivisor', multiplier: 'acCurrentMultiplier', forced: args.current, change: 0.05},
            ...
            voltage_phase_b: {attribute: 'rmsVoltagePhB', divisor: 'acVoltageDivisor', multiplier: 'acVoltageMultiplier', forced: args.voltage, change: 5},
            voltage_phase_c: {attribute: 'rmsVoltagePhC', divisor: 'acVoltageDivisor', multiplier: 'acVoltageMultiplier', forced: args.voltage, change: 5},
        },
        seMetering: {
            // Report change with every 5W change
